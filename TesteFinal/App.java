    ...
    public static void main(String[] args) {
        ...
        while (ligado) {
            ...
            switch (acao1) {
                ...
                case 3:
                   String nomeBuscado1 = JOptionPane.showInputDialog("Insira o Nome de Conta");
                    while (naoEncontrei2) {
                        if (nomeBuscado1.equals(conta[cont].getNome())) {
                            naoEncontrei = false;

                            String senhaDigitada = JOptionPane.showInputDialog(null, "Insira Senha de Acesso");
